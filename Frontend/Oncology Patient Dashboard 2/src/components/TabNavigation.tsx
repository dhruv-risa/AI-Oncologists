...
const tabs = [
  ...
  { id: 'clinical-trials', label: 'Clinical Trials', icon: Beaker },
        ...
        {tabs.map((tab) => {
          ...
          return (
            <button
              ...
              className={`flex items-center gap-2 px-4 py-2.5 text-sm transition-all rounded-lg whitespace-nowrap ${activeTab === tab.id
